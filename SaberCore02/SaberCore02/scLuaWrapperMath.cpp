...
void exportOgreMath( lua_State* L )
{
	...
	module(L)
		[
			...
			.def("angleBetween", (Ogre::Radian (Vector2::*)(const Ogre::Vector2 &))&Vector2::angleBetween)
			.def("angleTo", (Ogre::Radian (Vector2::*)(const Ogre::Vector2 &))&Vector2::angleTo)
	...
	module(L)
		[
			...
			.def("primaryAxis", (Vector3 (Vector3::*)())&Vector3::primaryAxis)
	...
	module(L)
		[
			...
			.def("FromAngleAxis", (void (Matrix3::*)(const Ogre::Vector3 &,  const Ogre::Radian &))&Matrix3::FromAngleAxis)
